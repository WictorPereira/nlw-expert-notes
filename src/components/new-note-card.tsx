         ...
         <Dialog.Overlay className='inset-0 fixed bg-black/50'/>
          ...
          <form onSubmit={handleSaveNote} className='flex-1 flex flex-col'>
            ...
            <div className='flex flex-1 flex-col gap-3 p-5'>
               ...
               {shouldShowOnborading ? (<p className="text-sm leading-6 text-slate-400"> 
               Comece <button className='font-medium text-lime-400 hover:underline'>gravando uma nota</button> em áudio ou se preferir <button onClick={handleStartEditor} className='font-medium text-lime-400 hover:underline'>utilize apenas texto.</button></p>
               ):(
                <textarea 
                autoFocus
